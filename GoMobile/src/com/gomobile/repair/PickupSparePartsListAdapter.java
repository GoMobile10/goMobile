...
public class PickupSparePartsListAdapter extends ArrayAdapter<Component> {
	...
	public PickupSparePartsListAdapter(Context context, int layoutResourceId,
			List<Component> spareparts) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView imageView = (ImageView) convertView
				.findViewById(R.id.scannedPic);
		TextView description = (TextView) convertView
				.findViewById(R.id.sparepartDescription);
		...
		description.setText(currentSparepart.getDescription() + " "
				+ currentSparepart.getEanNumber());
		return convertView;
	}
}