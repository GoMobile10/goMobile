...
/**
 * This list shows step by step what the repair guy has to do to repair the bike
 * 
 * @author Daniel
 * 
 */
public class RepairToDoList extends ViewWithNavigation {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// ListAdapter listenAdapter = new
		// PickupSparePartsListAdapter(RepairToDoList.this,
		// R.layout.rowlayout_sparepartspickuplist_item ,repairToDoListData);
		ListAdapter listAdapter = new ToDoListAdapter(RepairToDoList.this,
				R.layout.rowlayout_todolist_item, repairToDoListData);
		repairToDoListItem = (ListView) findViewById(R.id.repairToDoListItem);
		repairToDoListItem.setAdapter(listAdapter);

		setContentView(createNavigationInfo(R.id.repairToDoListId, this,
				"back", null, null, null));
	...
	public void navigateLeft() {
		...
		pickuplist.putExtra("BikeName",
				getIntent().getExtras().getString("BikeName"));
		pickuplist.putExtra("BikeEanNumber",
				getIntent().getExtras().getString("BikeEanNumber"));
